        ...
        <div className="row personal-info">
          ...
          <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <div className="image-container">
              <img className="img-fluid d-block" src="img/me.jpg" alt="" />
            </div>
          ...
          <div className="row col-xl-6 col-lg-6 col-md-12">
            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6">
              <ul className="list-1">
                ...
                <li>
                  <h6>
                    <span className="font-weight-600">Birthdate</span>15
                    February 2003
                  </h6>
                </li>
                <li>
              ...
              <ul className="list-2">
                ...
                <li>
                  <h6>
                    ...
                    giustinogragnaniello16@gmail.com
                  </h6>
                </li>
                <li>
                  <h6>
                    <span className="font-weight-600">Instagram</span>
                    gragnaniello_giustino
                  </h6>
                </li>
              </ul>
            </div>
                  ...
                  <div className="card">
                    <div className="card-header">
                      ...
                      <span className="d-block font-weight-400 uppercase">
                        ...
                        <span className="font-weight-700">Accenture</span>
                      </span>
                    </div>
                  ...
                  <div className="card">
                    <div className="card-header">
                      ...
                      <span className="d-block font-weight-400 uppercase">
                        Web developer
                        <span className="separator" />
                        <span className="font-weight-700">Start2Impact</span>
                      </span>
                    </div>
                    <div className="card-body">
                      <p>Coming soon...</p>
                  ...
                  <div className="card">
                    <div className="card-header">
                      ...
                      <span className="d-block font-weight-400 uppercase">
                        Workfully
                        <span className="separator" />
                        <span className="font-weight-700">Web developer</span>
                      </span>
                    </div>
                    <div className="card-body">
                      <p>Coming soon...</p>
